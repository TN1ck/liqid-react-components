...
function NativeSelect(_ref) {
    ...
    return _react2.default.createElement(
        'div',
        { className: _styles2.default['liq_native-select-container'] },
...
var Select = function (_React$Component) {
    ...
    function Select(props) {
        ...
        _this.searchForMultipleLetters = _this.searchForMultipleLetters.bind(_this);
    ...
    _createClass(Select, [{
        ...
        key: 'searchForMultipleLetters',
        value: function searchForMultipleLetters(code) {
            var _this4 = this;
            ...
            var clearingTime = 580;
            clearTimeout(this.clearCharStore);
            this.clearCharStore = setTimeout(function () {
                _this4.searchForMultipleLetters();
            }, clearingTime);
            // an item is only seekable if it has a value and is not disabled
            var validChild = function validChild(child) {
                return child.props.value && !child.props.disabled && child.props.children;
            };
            // go through children, check if it is a searchable child (see above)
            // return index when matching child value with pressed chars
            var matchingItemIndex = this.getChildren().findIndex(function (child) {
                if (validChild(child)) {
                    return _this4.charStore.join('').toLowerCase() === child.props.children.substring(0, _this4.charStore.length).toLowerCase();
                }
            });
            // go through children, check if is a searchable children, return index when
            var alternativeItemIndex = this.getChildren().findIndex(function (child) {
                if (validChild(child)) {
            ...
            var index = !validIndex(matchingItemIndex) && this.charStore.length <= 1 ? alternativeItemIndex : matchingItemIndex;
        ...
        value: function createShownValue() {
            ...
            var childWithValue = this.getChildren().filter(function (child) {
                return child.props.value === _this5.state.valueEncapsulated;
            });
        ...
        value: function render() {
            ...
            var wrapperClasses = (0, _classnames2.default)(_styles2.default['liq_select-simple'], (_classNames = {}, _defineProperty(_classNames, _styles2.default['select-simple-open'], !this.state.closed), _defineProperty(_classNames, _styles2.default.disabled, this.props.disabled), _classNames), this.props.className);
            ...
            return mobile ? _react2.default.createElement(NativeSelect, {
                ...
                _react2.default.createElement('input', {
                    ...
                    readOnly: true,
                    disabled: this.props.disabled,
                    className: [_styles2.default['liq_select-simple__input']],
                ...
                _react2.default.createElement(
                    'ul',
                    { className: _styles2.default['liq_select-simple-list'], ref: 'selectSimpleList' },
                    children.map(function (listItem, listItemIndex) {
                        var selected = listItemIndex === _this6.state.selectedItemIndex;
                        var active = listItem.props.value === _this6.state.valueEncapsulated;
                        return _react2.default.createElement(
                            _SelectItem2.default,
                            _extends({
                                ref: 'dropdownItem' + listItemIndex,
                                key: 'dropdown-item-' + listItemIndex
                            }, _this6.props, listItem.props, {
                                onMouseDown: _this6.applyValue,
                                selected: selected,
                                active: active,
                                indexInList: listItemIndex,
                                onMouseEnter: _this6.mouseSelectIndex
                            }),
                            listItem.props.children
                        );
                    })
