...
var Tooltips = function (_React$Component) {
    ...
    function Tooltips(props) {
        ...
        _this.getPositions = _this.getPositions.bind(_this);
    ...
    _createClass(Tooltips, [{
        ...
        value: function mountNode() {
            ...
            var placement = positions.includes(this.props.position) ? this.props.position : 'top';
        ...
        value: function render() {
            return _react2.default.createElement(
                'span',
                {
                    className: _styles2.default.liq_tooltips,
